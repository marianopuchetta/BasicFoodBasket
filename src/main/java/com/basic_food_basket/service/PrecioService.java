...
public class PrecioService implements IPrecioService {
    ...
    @Override
    public List<ProductoFallidoResumenProjection> obtenerResumenProductosFallidosUltimoScrapeo() {
        return precioRepository.findResumenProductosFallidosUltimoScrapeo();
    }
}
